"""Pandera ↔ polars dtype mapping helpers.

Split out of :mod:`hyperion.typeutils` (F5 / DDD refactor Step 2) so that the
stdlib half of ``typeutils`` no longer transitively loads the pandera/polars
data-validation stack. Requires the ``[data]`` extra.
"""
